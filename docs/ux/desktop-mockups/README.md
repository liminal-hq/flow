# Liminal Flow — Tauri Desktop Concept

Design mock-ups for a desktop companion to the `flo` CLI/TUI, targeting Tauri.
Each mock-up is a self-contained HTML file — open it in any browser. Annotated
callouts on each page explain the thinking.

| # | Mock-up | What it explores |
|---|---------|------------------|
