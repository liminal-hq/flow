...
Series 2 of the desktop exploration. Where [`docs/ux/desktop-mockups/`](../desktop-mockups/)
translated the existing CLI/TUI faithfully to a Tauri app, this series ignores
